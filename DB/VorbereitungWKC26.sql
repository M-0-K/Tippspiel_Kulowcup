...
SET
  MA = CASE
    WHEN MA = 1001 THEN 6
    WHEN MA = 1002 THEN 10
    WHEN MA = 1003 THEN 40
    WHEN MA = 1004 THEN 37
    WHEN MA = 1011 THEN 4
    WHEN MA = 1012 THEN 33
    WHEN MA = 1013 THEN 7
    WHEN MA = 1014 THEN 5
    ELSE MA
  END,
  MB = CASE
    WHEN MB = 1001 THEN 6
    WHEN MB = 1002 THEN 10
    WHEN MB = 1003 THEN 40
    WHEN MB = 1004 THEN 37
    WHEN MB = 1011 THEN 4
    WHEN MB = 1012 THEN 33
    WHEN MB = 1013 THEN 7
    WHEN MB = 1014 THEN 5
    ELSE MB
  END
